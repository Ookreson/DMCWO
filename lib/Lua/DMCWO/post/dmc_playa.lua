...
function PlayerTweakData:_init_new_stances()
	...
	local gun_drag = {'default','new_raging_bull','deagle','colt_1911','usp','p226','g22c','glock_17','glock_18c','b92fs','ppk','mac10','m45','mp9','new_mp5','mp7','p90','olympic','akmsu','akm','akm_gold','ak74','m16','amcar','new_m4','ak5','s552','g36','aug','saiga','r870','huntsman','benelli','ksg','serbu','striker','new_m14','scar','fal','hk21','rpk','m249','msr','r93','m95','judge','famas','galil','g3','gre_m79','china','tec9','scorpion','uzi','x_deagle','x_1911','x_b92fs','jowi','g26','spas12','mg42','mosin','c96','sterling','m1928','l85a2','vhs','hs2000','cobray','rpg7','b682','x_usp','x_g17','x_g22c','aa12','flamethrower_mk2','m32','plainsrider','peacemaker','winchester1874','m134','mateba','sub2000','asval','polymer','wa2000','hunter','baka','frankish','arblast','long','par','sparrow','model70'}
	...
	local med_weight_2 = {'serbu','s552','m16','m45','saiga','akm','scar','aug','huntsman','uzi','vhs','b682','flamethrower_mk2','arblast','china'}
	...
	if DMCWO.reposed_vms == true then
		...
		local pistol_type_wep = {'glock_17','glock_18c','g22c','g26','b92fs','usp','colt_1911','ppk','p226','c96','hs2000','deagle','sparrow'}
		...
		pivot_head_translation = Vector3( 0, 12, -20 )
		...
		pivot_head_translation = Vector3( 0, 25, -16 )
		pivot_head_rotation = Rotation(0.5, 0.5, 0)
		...
		self.stances.m249.bipod.FOV = 63
		...
		pivot_head_translation = Vector3( 0, 22, -5 )
		pivot_head_rotation = Rotation(0, 0, 0)
		...
		pivot_head_translation = Vector3( 0, 34, -7 )
		pivot_head_rotation = Rotation(3, 2, 2)
		...
		self.stances.hk21.bipod.FOV = 63
		...
		self.stances.mg42.bipod.FOV = 63
		--Winchester
