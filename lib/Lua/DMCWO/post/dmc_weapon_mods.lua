...
function WeaponFactoryTweakData:DMCWO_general()
	...
	--table.insert(self.wpn_fps_pis_beretta.uses_parts, "wpn_fps_pis_g18c_s_stock") -- attempting to get the G18 Stock on the beretta for the burstfire mod(practicality).
	...
	--SCAR Long Barrel
	self.parts.wpn_fps_ass_scar_b_long.stats = { value = 5, spread = 4, spread_moving = -3, concealment = -3, damage = 2, recoil = -3, suppression = 0, total_ammo_mod = -50}
	...
	self.parts.wpn_fps_ass_g3_b_short.stats = {value = 2, recoil = 1, spread = -2, concealment = 4, damage = -2, total_ammo_mod = 66 }
	--G3 Sniper Barrel
	...
	self.parts.wpn_fps_m4_uupg_fg_lr300.stats = { value = 5, concealment = 1, recoil = 5, spread = 0 }
	--Competition (CAR-4)
	...
	self.parts.wpn_fps_lmg_hk21_fg_short.stats = { value = 6, spread = -15, damage = -2, spread_moving = 2, concealment = 3, recoil = 10, suppression = -1 }
	...
	self.parts.wpn_fps_ass_fal_fg_01.stats = { value = 3, damage = -2, spread = -0, recoil = 0, concealment = 6, suppression = -2, total_ammo_mod = 66 }
	...
	--Galil MAR Handguard
	self.parts.wpn_fps_ass_galil_fg_mar.stats = { value = 4, recoil = -0, spread = -0, concealment = 4, damage = -2, suppression = -3, total_ammo_mod = 66}
	...
	self.parts.wpn_fps_ass_galil_fg_sniper.stats = { value = 5, recoil = -4, spread = 4, concealment = -2, damage = 3}
	...
	--Beretta M93 Stock
	--self.parts.wpn_fps_pis_beretta_m_extended.stats -Attempting to get G18 Stock on Beretta.
	...
	--AS Val VSS Stock
	self.parts.wpn_fps_ass_asval_s_solid.stats = { value = 1, recoil = 8, concealment = -3, total_ammo_mod = -66, damage = 14, damage_near_mul = 1.5, damage_far_mul = 1.5 }
...
self.parts.wpn_fps_upg_o_leupold.stance_mod.wpn_fps_pis_deagle = { translation = Vector3( 0.0025,-54.5,-5.71 ) }
	...
	self.parts.wpn_fps_upg_o_leupold.stance_mod.wpn_fps_ass_asval = { translation = Vector3( -0.002,-41.1, 5.6225 ) } --busted here, ( -0.002,-13.1, 5.6225 ) previous number
	...
	--[[
	To-Do List-
	Reduce damage on HE rounds for shotguns and remove crits on them as well (not sure why they are applying in the first place)
	Fix Saiga fire sound, repeating over and over again for some reason after being fired. - FIXED - Auto-fire sound fix mod was conflicting.
	Fix and rebalance ammo for shotguns, some of it's a bit too OP. - WIP - HE rounds ammo pickup removed, damage and ammo reduction scaled to match.
		Honestly, I'd like to get the HE rounds to do under 120 for all shotties, but that's not exactly the case here, is it. So scrap ammo pickup, leave enough ammo to be useable.
	--]]
	...
	self.parts.wpn_fps_upg_a_slug.stats = { value = 5, total_ammo_mod = -50, damage = -2, spread = 50, moving_spread = -5, recoil = -15 }
	self.parts.wpn_fps_upg_a_slug.custom_stats = { damage_far_mul = 2.5, rays = 1, armor_piercing_add = 1, can_shoot_through_enemy = true, can_shoot_through_shield = true, can_shoot_through_wall = true, ammo_pickup_min_mul = 0.85, ammo_pickup_max_mul = 0.85, damage_near_mul = 1, hipfire_mod = 1.2, hs_mult = 1, ignore_statistic = true, ignore_dmg_boosts = true }
	...
	self.parts.wpn_fps_upg_a_explosive.stats = { value = 5, total_ammo_mod = -75, damage = 1, spread = 30, moving_spread = 6, suppression = -110, recoil = -10 }
	self.parts.wpn_fps_upg_a_explosive.custom_stats = { ignore_statistic = true, rays = 1, damage_near_mul = 2.5, bullet_class = "InstantExplosiveBulletBase", ammo_pickup_min_mul = 0.00, ammo_pickup_max_mul = 0.00, hipfire_mod = 1.5, ignore_dmg_boosts = true }
	...
	self.wpn_fps_shot_serbu.override.wpn_fps_upg_a_explosive = { stats = { value = 5, total_ammo_mod = -100, damage = 0, spread = 4, moving_spread = 6, suppression = -110, recoil = -6 }}
	...
	-- Maybe the reason the HE rounds and slug rounds changed on the judge is because the judge is classified as a pistol?
	self.wpn_fps_pis_judge.override.wpn_fps_upg_a_explosive = {	stats = { value = 5, total_ammo_mod = -120, damage = 20, spread = 30, moving_spread = 6, suppression = -110, recoil = -6 } }
	
	self.wpn_fps_pis_judge.override.wpn_fps_upg_a_slug = { stats = { value = 5, total_ammo_mod = 50, damage = 2, spread = 35, moving_spread = 6, suppression = -110, recoil = -6 } }
